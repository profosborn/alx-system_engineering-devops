...
This project was the first of two introducing networking concepts. In this project, I answered few questions and wrote a couple bash scripts while learning about the OSI model, LAN and WAN networks, and TCP/UDP data transfer protocols.
